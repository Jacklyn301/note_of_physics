...
### 1. 一朝回到物理學解放前
#### 力跟能量有什麼關係?
- 我們知道，當力量碰到能量，這個能量就會以功的形式呈現出來，其中$W$為功，$r$為位移:
$$W=F\times r$$
- 那麼，如果這個力並不是一成不變的，而是會受到我的位置影響呢? 例如，地球的引力，理論上我離地球越靠近，受到的力量越大。$F$ 會改變，怎麼辦呢? 
- 我們可以做一張圖，縱軸為力量，橫軸為我離起點的距離，那麼我就可以做出二維平便座標的一條趨勢，描述所受的力量跟位移的關係。
> [!Tip] 
> <span style="color: #60af3e;font-weight: bold">那這時W相當於什麼? 欸沒錯，就是**趨勢線下的面積** !</span> 😏
- 如果我的引力跟離原點的距離有一個特定的關係 (而事實就是真的有關係，等下就會看到了)，這個關係可以做成一個公式，並且該公式在平面座標上可呈現出連續的線。
- 只要能推論出線下的體積會如何隨著力量跟距離的變化而變化，那我就可以推導出做功 (也就是能量)的具體公式。這個過程，叫做**對該公式積分**，呈現如下:
$$W=\int F\, dr$$
#### 能量轉換
- 各個能量都可以轉換，因此我們等一下會根據能量守恆定律來推導出

### 2. 思想實驗
> [!Warning] 
> <span style="color: #ff751f;font-weight: bold">在開始我們的腦力激盪之前，讓我們拋開任何實際上會遇到的問題，先把重力當成一個點就好。沒錯，就是一個質點就好</span> 🤔
...
- 就像是兩個水槽，一個是動能一個是位能，隨著我越來越接近重力點，重力對我的作功越大，我的動能水位越來越高，位能水位越來越低。
> [!Important]
> <span style="color: #1c39ff;font-weight: bold">記得，能量守恆! </span> 👀


![kfje11](https://hackmd.io/_uploads/Hy_Qy6YuZg.jpg)
...
### 3. 不嚴謹的錯誤算法
- 要是你是一個國中生，你其實可以用錯誤的方式巧合算出史瓦西半徑
#### 在這之前我們先來了解何謂逃逸速度
...
![Screenshot 2026-02-23 143847](https://hackmd.io/_uploads/r1bRC3YOZe.png)
