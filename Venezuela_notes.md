...
![image alt](https://www.mapsofindia.com/world-map/venezuela/venezuela-states-and-capital-map.jpg)
...
![image alt](https://news.cgtn.com/news/3359444f33597a6333566d54/img/9e1eb6a4-36d7-403e-9ccc-57cc35aae3b6.jpg)
...
![image alt](https://raw.githubusercontent.com/Jacklyn301/note_of_selflearning/main/Washington_Consensus_0727.png)
...
A(如果我今天存)-->E(降低財政支出)-->F(選民暴動)-.->D
A-->C(有幸繼續存著<br>成為國家基金)-->B(下一任可能<br>直接花掉)
...
Oil(["🛢️ Oil Boom"])
Revenue(["💵<br>Government<br>Revenue"])
Patronage(["🤝<br>Patronage<br>Politics"])
Corruption(["💰<br>Corruption"])
Institution(["⚖️<br>Weak<br>Institutions"])
Investment(["🏭<br>Weak<br>Private<br>Investment"])
Diversification(["📉<br>Poor<br>Economic<br>Diversification"])
Dependence(["🛢️ Oil Dependence"])
...
![image alt](https://eldiario.com/nitropack_static/DWpklAePbJBFiBKvuTtiGMLbtJlHUqWt/assets/images/optimized/rev-52ac03a/eldiario.com/wp-content/uploads/2022/02/Carlos-Andres-Perez.jpg.webp)
...
![image alt](https://www.biosiglos.com/wp-content/uploads/2008/06/simon-bolivar-1.jpg)
...
![image alt](https://bog.dk/wp-content/uploads/2024/09/1920x1080-m-forf_Nexus-1.jpg)
...
```mermaid
flowchart LR
a([人民拿到錢])-->b([去銀行])-->c([提出申請<br>政府審核])-->d([也許給你 🙂])
c-->e([也許不給 🙂])
```
...
![image alt](https://raw.githubusercontent.com/Jacklyn301/note_of_selflearning/main/Demand%20and%20supply%E2%80%93market%20equilibrium-shortage.png)
...
A-->B([降低支出])-->r1([人民會<br>非常不爽])
A-->C([增加人民稅收])-->r1
A-->D([對外借錢])-->E([委內瑞拉<br>債信評等崩壞])-->r2([利率一路<br>標高])
A-->F([印錢])-->r3([Um... 🙂])
```
...
![image alt](https://raw.githubusercontent.com/Jacklyn301/note_of_selflearning/main/annual_variation_of_real_GDP_in_Venezuela_0727.png)
...
![image alt](https://raw.githubusercontent.com/Jacklyn301/note_of_selflearning/main/ve's_annual_inflation_rate_0727.jpg)
